...
export default async function Nav() {
  return (
    <nav className="fixed top-0 flex items-center w-full h-24 from-indigo-900 to-indigo-950 bg-gradient-to-b rounded-b-3xl justify-between">
      <div className="flex items-center gap-4 px-8">
        <h1 className=" text-2xl text-headline">
          Compounds<span className="text-contrast font-bold">IO</span>
        </h1>
        <Link href="/playground">
          <p className="text-md text-contrast">Playground</p>
        </Link>
      </div>
    </nav>
  );
